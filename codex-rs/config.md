...
## sandbox_mode (REMOVED)

**Sandbox functionality has been completely removed from codex-rs.**

All commands now execute with full system access. If you need sandboxing, consider running codex-rs inside a Docker container or other external sandbox environment.
