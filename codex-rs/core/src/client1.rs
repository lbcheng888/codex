...
/// Deprecated: client1 has been collapsed into core/src/client.rs.
/// This file now only hosts SSE helpers temporarily until we extract a shared module.
    ...
    S: futures::Stream<Item = Result<Bytes>> + Unpin,
{
    ...
    loop {
                ...
                match response_completed {
                    Some(ResponseCompleted {
                        ...
                        let event = ResponseEvent::Completed {
                            response_id,
                            token_usage: usage.map(|u| crate::protocol::TokenUsage {
        ...
        trace!(?event, "SSE event (client1 deprecated module)");
...
/// used in tests to stream from a text SSE file (kept for compatibility)
