...
impl Default for EmbedderConfig {
    fn default() -> Self {
        Self {
            provider: EmbeddingProvider::Qwen3EmbedAnything, // Use Qwen3-Embedding by default
            api_key: String::new(),
            model: "Qwen/Qwen3-Embedding-0.6B".to_string(), // Qwen3-Embedding-0.6B model
            dimension: 1024,                                // Dimension for Qwen3-Embedding-0.6B
            batch_size: 32,                                 // Batch size for Qwen3
            timeout: Duration::from_secs(120),              // Longer timeout for model loading
        }
    }
}
